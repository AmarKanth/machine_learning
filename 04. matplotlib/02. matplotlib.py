...
fig, ax = plt.subplots()
ax.plot(ca_housing_markets.index, ca_housing_markets["San Francisco"] / 1000000, label="San Francisco", color="green")
ax.plot(ca_housing_markets.index, ca_housing_markets["Los Angeles"] / 1000000, label="Los Angeles", color="purple")
