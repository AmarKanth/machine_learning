...
- This is useful when we haven't large datasets. 
- It is applied to find the similarity and dissimilarities between the two images.
"""
...
- These two values represent the distances between the two points in an n-dimensional plane. 
- The only difference between the two is in the way the two are calculated.
